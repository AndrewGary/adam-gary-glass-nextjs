	...
	return (
		<div className="w-full bg-gray-800 text-white flex flex-col justify-center py-2 transition-all">
			<div className="w-full flex">
				...
				>
					<SVGIcon data-testid="hamburgerMenuIcon" type="hamburgerMenu" />
				</div>
				...
				<div className="w-1/5 flex justify-end items-center pr-2 space-x-1">
					<div className="relative">
						...
						<Link href="/Cart">
							<SVGIcon data-testid="shoppingCartIcon" type="shoppingCart" />
						</Link>
					</div>
					<div
						onClick={() => {
					...
					>
						<SVGIcon data-testid="searchIcon" type="searchIcon" />
					</div>
				</div>
			</div>
