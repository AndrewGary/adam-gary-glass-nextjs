  ...
  return (
    <div className=" w-full min-h-screen flex flex-col items-center">
      <div className="max-w-3xl w-[90%] flex flex-col space-y-3">
        <h1 className=" border-y text-2xl uppercase border-black">
        ...
        <span>
          Your use of this site and the information available on this site is
          subject to the following terms and conditions:
        </span>
        <span className="uppercase font-bold">
          YOU MUST BE AT LEAST 21 YEARS OR OLDER (18 IN SOME AREAS) TO ORDER OR
          PURCHASE FROM ADAMGARYGLASS.COM
        </span>

        <h3 className="uppercase font-bold">Overview</h3>
        <p>
          This website is operated by Adam Gary Glass. Throughout the site, the
          terms “I’, “me”, “we”, “us” and “our” refer to Adam Gary Glass. Adam
          Gary Glass offers this website, including all information, tools and
        ...
        <p>
          ...
          at anytime without notice, at the sole discretion of us. We reserve
        ...
        <p>
          <span className="font-bold">
            The items contained on these pages are being sold as collectible
            glass art.
          </span>{" "}
          Any items that appear functional as a smoking device should be
          considered for tobacco use <span className="font-bold">only</span>. No
          other use for these items in any way is either intended or condoned.
          You must be at least 18 years of age (21 in some areas) to purchase
          any items on this website, and it is your responsibility to know your
          local as well as state and countries regulations regarding these
          items. Furthermore, you release and discharge all involved in the
          production and maintenance of this website from any and all
          liabilities.
        </p>
        <p>
          Restrictions on Use – This site is available only for your personal,
          non-commercial use. You may not copy, reproduce, republish, post,
          distribute, transmit, or modify in any way any part of this site.
        </p>
        <p>
          Certain products advertised within this site may not be legal in all
          countries. We would request that all customers check the laws of their
          country before viewing products from our website.
        </p>
        <p>
          All items of smoking paraphernalia are for ornamental purposes or for
          the use of legal smoking mixes only. They are NOT intended for illegal
          use.
        </p>
        ...
        <p>
          In no case shall Gus Glass, our directors, officers, employees,
        ...
        <p>
          You agree to indemnify, defend and hold harmless Gus Glass and our
        ...
        <p>
          ...
          this site have not be evaluated by the FDA (United States Food & Drug
          Administration) nor the European Medicines Evaluation Agency (EMEA)
          and are not approved to diagnose, treat, cure or prevent disease. The
          ...
          other health care professional or any information contained on or in
          any product label or packaging. You should consult with a health care
          ...
          might have a health problem. Any information provided is purely for
          historical, scientific and educational purposes and should never be
          interpreted as a recommendation for a specific treatment plan,
          product, and course of action of medical or cosmetic treatment.
          Persons with serious medical conditions should seek professional care
        </p>
        <p>
          By using this site, you are acknowledging your consent to these terms
