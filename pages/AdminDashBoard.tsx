...
const AdminDashBoard = (props: Props) => {
  return (
    <div className="w-full flex flex-wrap justify-evenly">
      <Link
        href={"/"}
        className=" w-44 h-44 button-styles flex justify-center items-center mt-1"
      >
        4 New Messages
      </Link>
      ...
      <Link className="w-44 h-44 button-styles flex justify-center items-center mt-1" href={"/AddNewProduct"}>
        Add New Product
      </Link>
      <Link className="w-44 h-44 button-styles flex justify-center items-center mt-1" href={"/EditProducts"}>
        Edit Products
      </Link>
    </div>
  );
